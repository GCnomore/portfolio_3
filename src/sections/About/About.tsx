  ...
  return (
    <Styled.Container>
      ...
      <Styled.Content>
        ...
        <Styled.P2>GOOD WAY</Styled.P2> to say that I didn't majored in computer
        science, I am a self-taught, freshman deveolper who just took a first
        step into the software world.{" "}
        <Styled.P2>
          (People can have someone teach them, but in the end, learning is up to
